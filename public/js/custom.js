  ...
  $.each(trellomem.slice(0.10), function(i, member){
   ...
   if(list.id == card.idList){
     ...
     (card.badges.description != true ? ' ' : '<p>'+'Description: ' + card.desc+'</p>')
      +'</div>'+'<div class="panel-body" id = "2"><div class ="col-md-5">'+(member.id == card.idMembers ? '<div class="thumbnail">'+'<img src="https://trello-avatars.s3.amazonaws.com/'+ member.avatarHash +'/30.png'+'" />'+'<p>'+member.username+'</p></div>':"")
     +'</div></div>';
